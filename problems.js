...
function genMathFromDataset(list, tag, typeId) {
  ...
  const problemTypes = [    
    ...
    {id:"kingside_mate1_lvl1", gen:()=>genFromDataset(window.PuzzleKingsideMateIn1Level1Problems, "kingside_mate1_lvl1")},
    {id:"opera_mate1_lvl1", gen:()=>genFromDataset(window.PuzzleOperaMateIn1Level1Problems, "opera_mate1_lvl1")},
    ...
    {id:"queenrooken_mate1_lvl1", gen:()=>genFromDataset(window.PuzzleQueenRookEnMateIn1Level1Problems, "queenrooken_mate1_lvl1")},
    {id:"fork_lvl2", gen:()=>genFromDataset(window.PuzzleForkLevel2Problems, "fork_lvl2")},
  ];
